# -*- coding: utf-8 -*-
"""
Created on Mon May 28 14:29:11 2018
...
from attention_blstm_model.data_gen import Corpus
...
def build_model(nb_classes, word_index, embedding_dim, seq_length, stamp):
    ...
    embedding_layer=Embedding(input_dim=nb_words+1, output_dim=embedding_dim, 
                              input_length=seq_length, weights=[embedding_matrix], 
    ...
    with open('data_path_save/attention_blstm/'+stamp+'.json', 'w') as json_file:
