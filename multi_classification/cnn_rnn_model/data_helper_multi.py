...
def load_data(filename):
    ...
    for i in range(len(df)):
        ...
        for y_label in y_labels:
            if y_label not in label_dict.keys():
                label_dict[y_label]=len(label_dict.items())
    label_dict['<unk>']=len(label_dict.items())
    ...
    y=np.array(y_raw)
    return x, y, vocabulary, vocabulary_inv, df, label_dict

if __name__=='__main__': 
    train_file='labeled_text.csv'
    x, y, vocabulary, vocabulary_inv, df, label_dict=load_data(train_file)
