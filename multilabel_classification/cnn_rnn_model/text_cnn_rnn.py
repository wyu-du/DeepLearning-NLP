# -*- coding: utf-8 -*-
"""
Created on Wed Apr 25 12:48:19 2018
...
class TextCNNRNN(object):
    def __init__(self, embedding_mat, non_static, hidden_unit, sequence_length, max_pool_size,
        ...
        with tf.device('/cpu:0'), tf.name_scope('embedding'):
            ...
            # change shape=(None, sequence_length, embedding_size) to shape=(None, sequence_length, embedding_size, 1)
            emb=tf.expand_dims(self.embedded_chars, -1)
        
        pooled_concat=[]
        # 返回大于(sequence_length)*1.0/max_pool_size的最小整数
        ...
        # For example, [3, 4, 5] means filters that slide over 3, 4 and 5 words respectively, for a total of 3 * num_filters filters.
        ...
        # 在第3维上连接每一个convolutional filters的输出
